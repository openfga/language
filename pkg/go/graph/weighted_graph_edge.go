...
const (
	...
	// however, when there is not operator node involved then the LogicalDirectGrouping is not created to avoid unnecessary nested nodes creation
	...
	// however, when there is not operator node involved then the LogicalTTUGrouping is not created to avoid unnecessary nested nodes creation
