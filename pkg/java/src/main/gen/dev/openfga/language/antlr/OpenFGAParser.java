...
public class OpenFGAParser extends Parser {
	...
	public static final int
		...
		STRING=52, BYTES=53, DOLLAR_EXPRESSION=54, EXTENDED_IDENTIFIER=55, NEWLINE=56, 
		CONDITION_PARAM_CONTAINER=57, CONDITION_PARAM_TYPE=58;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"NUM_FLOAT", "NUM_INT", "NUM_UINT", "STRING", "BYTES", "DOLLAR_EXPRESSION", 
			"EXTENDED_IDENTIFIER", "NEWLINE", "CONDITION_PARAM_CONTAINER", "CONDITION_PARAM_TYPE"
		};
	}
	...
	public static class RelationDefTypeRestrictionContext extends ParserRuleContext {
		...
		public TerminalNode DOLLAR_EXPRESSION() { return getToken(OpenFGAParser.DOLLAR_EXPRESSION, 0); }
	...
	public final MultiLineCommentContext multiLineComment() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 504403158265495550L) != 0)) {
				{
				{
				setState(370);
				_la = _input.LA(1);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(386);
						_la = _input.LA(1);
						if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 90071923693717432L) != 0)) ) {
						_errHandler.recoverInline(this);
						}
						else {
							if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
