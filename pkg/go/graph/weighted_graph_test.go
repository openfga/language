...
func TestValidWeight1OneTerminalType(t *testing.T) {
	...
	require.Len(t, graph.nodes["state-member"].wildcards, 0)
...
func TestInvalidWeight1WithAndModelCycle(t *testing.T) {
	...
	require.Len(t, graph.nodes["state-can_view"].wildcards, 0)
	require.Len(t, graph.nodes["state-can_view-or"].wildcards, 0)
	require.Len(t, graph.nodes["state-member"].wildcards, 0)
	require.Len(t, graph.nodes["state-owner"].wildcards, 0)
	require.Len(t, graph.nodes["state-owner-and"].wildcards, 0)
	require.Len(t, graph.nodes["user"].wildcards, 0)
...
func TestValidWeight1MultipleTerminalTypes(t *testing.T) {
	...
	require.Len(t, graph.nodes["state-can_view-or"].wildcards, 0)
	require.Len(t, graph.nodes["state-owner-and"].wildcards, 0)
	require.Len(t, graph.nodes["state-approved_member"].wildcards, 0)
	require.Len(t, graph.nodes["state-can_apply"].wildcards, 0)
	require.Len(t, graph.nodes["state-can_apply-but"].wildcards, 0)
	require.Len(t, graph.nodes["state-can_apply-or"].wildcards, 0)
}
...
func TestValidWeight2TTUOneTerminalType(t *testing.T) {
	...
	require.Len(t, graph.nodes["state-owner-and"].wildcards, 0)
	require.Len(t, graph.nodes["state-approved_member"].wildcards, 0)
	require.Len(t, graph.nodes["transition-end"].wildcards, 0)
	require.Len(t, graph.nodes["transition-start"].wildcards, 0)
...
func TestValidWeight2MultipleTerminalType(t *testing.T) {
	...
	require.Len(t, graph.nodes["company-member"].wildcards, 0)
	require.Len(t, graph.nodes["company-owner"].wildcards, 0)
	require.Len(t, graph.nodes["company-approved_member"].wildcards, 0)
	require.Len(t, graph.nodes["company-approved_member-or"].wildcards, 0)
	require.Len(t, graph.nodes["group-approved_member"].wildcards, 0)
	require.Len(t, graph.nodes["license-active_member"].wildcards, 0)
	require.Len(t, graph.nodes["license-owner"].wildcards, 0)
}
...
func TestValidTupleCycle(t *testing.T) {
	...
	require.Len(t, graph.nodes["document-rel1"].wildcards, 0)
	require.Len(t, graph.nodes["document-rel2"].wildcards, 0)
	require.Len(t, graph.nodes["document-rel3"].wildcards, 0)
	require.Len(t, graph.nodes["document-rel4"].wildcards, 0)
	require.Len(t, graph.nodes["document-rel5"].wildcards, 0)
	require.Len(t, graph.nodes["document-rel6"].wildcards, 0)
	require.Len(t, graph.nodes["document-rel7"].wildcards, 0)
}
...
func TestValidTupleCycleWithInterceptionNotInCycle(t *testing.T) {
	...
	require.Len(t, graph.nodes["document-rel1"].wildcards, 0)
	require.Len(t, graph.nodes["document-rel1-and"].wildcards, 0)
	require.Len(t, graph.nodes["document-rel2"].wildcards, 0)
	require.Len(t, graph.nodes["document-rel3"].wildcards, 0)
	require.Len(t, graph.nodes["document-rel4"].wildcards, 0)
	require.Len(t, graph.nodes["document-rel4-or"].wildcards, 0)
	require.Len(t, graph.nodes["document-rel5"].wildcards, 0)
	require.Len(t, graph.nodes["document-rel6"].wildcards, 0)
	require.Len(t, graph.nodes["document-rel7"].wildcards, 0)
}
...
func TestValidRecursionWithWeight3(t *testing.T) {
	...
	require.Len(t, graph.nodes["group-owner"].wildcards, 0)
	require.Len(t, graph.nodes["state-can_view"].wildcards, 0)
	require.Len(t, graph.nodes["state-can_view-or"].wildcards, 0)
	require.Len(t, graph.nodes["transition-start"].wildcards, 0)
	require.Len(t, graph.nodes["transition-end"].wildcards, 0)
	require.Len(t, graph.nodes["transition-end"].wildcards, 0)
	require.Len(t, graph.nodes["group-owner"].wildcards, 0)
	require.Len(t, graph.nodes["group-max_owner"].wildcards, 0)
}
...
func TestValidRecursionWithMultipleWeightsAndTypes(t *testing.T) {
	...
	require.Len(t, graph.nodes["company-user_in_context"].wildcards, 0)
	require.Len(t, graph.nodes["group-approved_member"].wildcards, 0)
	require.Len(t, graph.nodes["group-approved_member-butnot"].wildcards, 0)
	require.Len(t, graph.nodes["group-member"].wildcards, 0)
	require.Len(t, graph.nodes["group-user_in_context"].wildcards, 0)
	require.Len(t, graph.nodes["group-reader"].wildcards, 0)
	require.Len(t, graph.nodes["group-assignee"].wildcards, 0)
	...
	require.Len(t, graph.nodes["license-holder"].wildcards, 0)
	require.Len(t, graph.nodes["license-parent"].wildcards, 0)
	...
	require.Len(t, graph.nodes["tier-assignee"].wildcards, 0)
	require.Len(t, graph.nodes["tier-subtier_owner"].wildcards, 0)
	require.Len(t, graph.nodes["tier-assignee_sub"].wildcards, 1)
	require.Len(t, graph.nodes["tier-assignee_sub-and"].wildcards, 1)
	require.Len(t, graph.nodes["module-associated_license"].wildcards, 0)
	require.Len(t, graph.nodes["module-module_holder"].wildcards, 1)
	require.Len(t, graph.nodes["module-module_user"].wildcards, 1)
	require.Len(t, graph.nodes["feature-associated_module"].wildcards, 0)
	require.Len(t, graph.nodes["feature-associated_tier"].wildcards, 0)
