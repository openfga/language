...
// EnterRelationDefTypeRestrictionWithCondition is called when production relationDefTypeRestrictionWithCondition is entered.
func (s *BaseOpenFGAParserListener) EnterRelationDefTypeRestrictionWithCondition(ctx *RelationDefTypeRestrictionWithConditionContext) {}

// ExitRelationDefTypeRestrictionWithCondition is called when production relationDefTypeRestrictionWithCondition is exited.
func (s *BaseOpenFGAParserListener) ExitRelationDefTypeRestrictionWithCondition(ctx *RelationDefTypeRestrictionWithConditionContext) {}
