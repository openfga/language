...
func TestValidWeight1OneTerminalType(t *testing.T) {
	...
	graph.AddNode("state-can_view", "can_view", SpecificTypeAndRelation, "state-can_view")
	graph.AddNode("state-can_view-or", UnionOperator, OperatorNode, "state-can_view")
	graph.AddNode("state-member", "member", SpecificTypeAndRelation, "state-member")
	graph.AddNode("state-owner", "owner", SpecificTypeAndRelation, "state-owner")
	graph.AddNode("state-owner-and", IntersectionOperator, OperatorNode, "state-owner")
	graph.AddNode("state-approved_member", "approved_member", SpecificTypeAndRelation, "state-approved_member")
	graph.AddNode("state-can_apply", "can_apply", SpecificTypeAndRelation, "state-can_apply")
	graph.AddNode("state-can_apply-but", ExclusionOperator, OperatorNode, "state-can_apply")
	graph.AddNode("state-can_apply-or", UnionOperator, OperatorNode, "state-can_apply")
...
func TestValidWeight2TTUOneTerminalType(t *testing.T) {
	...
	graph.AddNode("user:*", "user:*", SpecificTypeWildcard, "")
	graph.AddNode("transition-start", "start", SpecificTypeAndRelation, "transition-start")
	graph.AddNode("transition-end", "end", SpecificTypeAndRelation, "transition-end")
	graph.AddNode("transition-can_apply", "can_apply", SpecificTypeAndRelation, "transition-can_apply")
	graph.AddNode("transition-can_apply-and", IntersectionOperator, OperatorNode, "transition-can_apply")
...
func TestValidWeight2MultipleTerminalType(t *testing.T) {
	t.Parallel()
	graph := NewWeightedAuthorizationModelGraph()
	graph.AddNode("company-member", "member", SpecificTypeAndRelation, "company-member")
	graph.AddNode("company-owner", "owner", SpecificTypeAndRelation, "company-owner")
	graph.AddNode("company-approved_member", "approved_member", SpecificTypeAndRelation, "company-approved_member")
	graph.AddNode("company-approved_member-or", UnionOperator, OperatorNode, "company-approved_member")
	graph.AddNode("group-approved_member", "approved_member", SpecificTypeAndRelation, "group-approved_member")
	graph.AddNode("employee", "employee", SpecificType, "")
	graph.AddNode("company", "company", SpecificType, "")
	graph.AddNode("group", "group", SpecificType, "")
	graph.AddNode("user", "user", SpecificType, "")
	graph.AddNode("license-active_member", "active_member", SpecificTypeAndRelation, "license-active_member")
	graph.AddNode("license-owner", "owner", SpecificTypeAndRelation, "license-owner")
...
func TestWeight2ButNotMistmatchType(t *testing.T) {
	...
	graph := NewWeightedAuthorizationModelGraph()
	graph.AddNode("company-member", "member", SpecificTypeAndRelation, "company-member")
	graph.AddNode("company-executive", "executive", SpecificTypeAndRelation, "company-executive")
	graph.AddNode("company-approved_member", "approved_member", SpecificTypeAndRelation, "company-approved_member")
	graph.AddNode("company-can_execute", "can_execute", SpecificTypeAndRelation, "company-can_execute")
	graph.AddNode("employee", "employee", SpecificType, "")
	graph.AddNode("company-can_execute-but", ExclusionOperator, OperatorNode, "company-can_execute")
	graph.AddNode("user", "user", SpecificType, "")
...
func TestValidTupleCycle(t *testing.T) {
	t.Parallel()
	graph := NewWeightedAuthorizationModelGraph()
	graph.AddNode("document-rel4", "rel4", SpecificTypeAndRelation, "document-rel4")
	graph.AddNode("document-rel4-or", UnionOperator, OperatorNode, "document-rel4")
	graph.AddNode("document-rel6", "rel6", SpecificTypeAndRelation, "document-rel6")
	graph.AddNode("document-rel7", "rel7", SpecificTypeAndRelation, "document-rel7")
	graph.AddNode("document-rel1", "rel1", SpecificTypeAndRelation, "document-rel1")
	graph.AddNode("document-rel1-or", UnionOperator, OperatorNode, "document-rel1")
	graph.AddNode("document-rel2", "rel2", SpecificTypeAndRelation, "document-rel2")
	graph.AddNode("document-rel3", "rel3", SpecificTypeAndRelation, "document-rel3")
	graph.AddNode("document-rel5", "rel5", SpecificTypeAndRelation, "document-rel5")
	graph.AddNode("user", "user", SpecificType, "")
	graph.AddNode("employee", "employee", SpecificType, "")
...
func TestInvalidTupleCycleWithInterceptionOfTerminalTypes(t *testing.T) {
	...
	graph.AddNode("document-rel4", "rel4", SpecificTypeAndRelation, "document-rel4")
	graph.AddNode("document-rel4-or", UnionOperator, OperatorNode, "document-rel4")
	graph.AddNode("document-rel4-and", IntersectionOperator, OperatorNode, "document-rel4")
	graph.AddNode("document-rel6", "rel6", SpecificTypeAndRelation, "document-rel6")
	graph.AddNode("document-rel7", "rel7", SpecificTypeAndRelation, "document-rel7")
	graph.AddNode("document-rel1", "rel1", SpecificTypeAndRelation, "document-rel1")
	graph.AddNode("document-rel1-or", UnionOperator, OperatorNode, "document-rel1")
...
func TestValidTupleCycleWithInterceptionNotInCycle(t *testing.T) {
	...
	graph.AddNode("document-rel7", "rel7", SpecificTypeAndRelation, "document-rel7")
	graph.AddNode("document-rel1", "rel1", SpecificTypeAndRelation, "document-rel1")
	graph.AddNode("document-rel1-and", IntersectionOperator, OperatorNode, "document-rel1")
	graph.AddNode("document-rel2", "rel2", SpecificTypeAndRelation, "document-rel2")
	graph.AddNode("document-rel3", "rel3", SpecificTypeAndRelation, "document-rel3")
	graph.AddNode("document-rel5", "rel5", SpecificTypeAndRelation, "document-rel5")
	graph.AddNode("user", "user", SpecificType, "")
...
func TestValidRecursionWithWeight3(t *testing.T) {
	...
	graph.AddNode("transition-can_apply", "can_apply", SpecificTypeAndRelation, "transition-can_apply")
	graph.AddNode("transition-can_apply-and", IntersectionOperator, OperatorNode, "transition-can_apply")
	graph.AddNode("group-owner", "owner", SpecificTypeAndRelation, "group-owner")
	graph.AddNode("group-max_owner", "max_owner", SpecificTypeAndRelation, "group-max_owner")
...
func TestValidRecursionWithMultipleWeightsAndTypes(t *testing.T) {
	...
	graph.AddNode("company-approved_member", "approved_member", SpecificTypeAndRelation, "company-approved_member")
	graph.AddNode("company-approved_member-and", IntersectionOperator, OperatorNode, "company-approved_member")
	graph.AddNode("company-member", "member", SpecificTypeAndRelation, "company-member")
	graph.AddNode("company-facilitator", "facilitator", SpecificTypeAndRelation, "company-facilitator")
	graph.AddNode("company-user_in_context", "user_in_context", SpecificTypeAndRelation, "company-user_in_context")

	graph.AddNode("group-approved_member", "approved_member", SpecificTypeAndRelation, "group-approved_member")
	graph.AddNode("group-approved_member-butnot", ExclusionOperator, OperatorNode, "group-approved_member")
	graph.AddNode("group-member", "member", SpecificTypeAndRelation, "group-member")
	graph.AddNode("group-user_in_context", "user_in_context", SpecificTypeAndRelation, "group-user_in_context")
	graph.AddNode("group-reader", "reader", SpecificTypeAndRelation, "group-reader")
	graph.AddNode("group-assignee", "assignee", SpecificTypeAndRelation, "group-assignee")

	graph.AddNode("license-active_holder", "active_holder", SpecificTypeAndRelation, "license-active_holder")
	graph.AddNode("license-active_holder-or", UnionOperator, OperatorNode, "license-active_holder")
	graph.AddNode("license-holder_member", "holder_member", SpecificTypeAndRelation, "license-holder_member")
	graph.AddNode("license-holder_approved_member", "holder_approved_member", SpecificTypeAndRelation, "license-holder_approved_member")
	graph.AddNode("license-holder", "holder", SpecificTypeAndRelation, "license-holder")
	graph.AddNode("license-parent", "parent", SpecificTypeAndRelation, "license-parent")
	graph.AddNode("license-trust_holder", "trust_holder", SpecificTypeAndRelation, "license-trust_holder")
	graph.AddNode("license-trust_holder-or", UnionOperator, OperatorNode, "license-trust_holder")
	graph.AddNode("license-owner", "owner", SpecificTypeAndRelation, "license-owner")

	graph.AddNode("tier-subscriber", "subscriber", SpecificTypeAndRelation, "tier-subscriber")
	graph.AddNode("tier-assignee", "assignee", SpecificTypeAndRelation, "tier-assignee")
	graph.AddNode("tier-subtier_owner", "subtier_owner", SpecificTypeAndRelation, "tier-subtier_owner")
	graph.AddNode("tier-assignee_sub", "assignee_sub", SpecificTypeAndRelation, "tier-assignee_sub")
	graph.AddNode("tier-assignee_sub-and", IntersectionOperator, OperatorNode, "tier-assignee_sub")

	graph.AddNode("module-associated_license", "associated_license", SpecificTypeAndRelation, "module-associated_license")
	graph.AddNode("module-module_holder", "module_holder", SpecificTypeAndRelation, "module-module_holder")
	graph.AddNode("module-module_user", "module_user", SpecificTypeAndRelation, "module-module_user")

	graph.AddNode("feature-associated_module", "associated_module", SpecificTypeAndRelation, "feature-associated_module")
	graph.AddNode("feature-associated_tier", "associated_tier", SpecificTypeAndRelation, "feature-associated_tier")
	graph.AddNode("feature-tier_can_access", "tier_can_access", SpecificTypeAndRelation, "feature-tier_can_access")
	graph.AddNode("feature-can_access", "can_access", SpecificTypeAndRelation, "feature-can_access")
	graph.AddNode("feature-can_access-and", IntersectionOperator, OperatorNode, "feature-can_access")
...
func TestValidMixedRecursionWithTupleCycles(t *testing.T) {
	...
	graph := NewWeightedAuthorizationModelGraph()
	graph.AddNode("state-member", "member", SpecificTypeAndRelation, "state-member")
	graph.AddNode("state-member-or", UnionOperator, OperatorNode, "state-member")
	graph.AddNode("state-member-or-or", UnionOperator, OperatorNode, "state-member")
	graph.AddNode("state-parent", "parent", SpecificTypeAndRelation, "state-parent")
	graph.AddNode("state-parent_member", "parent_member", SpecificTypeAndRelation, "state-parent_member")
	graph.AddNode("user", "user", SpecificType, "")
	graph.AddNode("user:*", "user", SpecificTypeWildcard, "")
	graph.AddNode("state", "state", SpecificType, "")
...
func TestGetEdgesFromNodeID(t *testing.T) {
	...
	t.Run("preserves_edge_order", func(t *testing.T) {
		...
		// Add nodes
		graph.AddNode("parent", "parent", SpecificTypeAndRelation, "parent")
